...
int main() {
	...
	system("mode 150");
	cout << "                                  PAINTERS FINESSE INC" << endl;
	cout << "                                  135-15 227st NY, 11413" << endl;
	cout << "                                  PAINTERSFINESSEINC@gmail.com" << endl;
	cout << "                                  TEL: (347)-567-1937" << endl << endl << endl;
